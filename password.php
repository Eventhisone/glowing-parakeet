    ...
    if(empty($errors)) { // If everything's OK
        ...
        if ($num == 1) { // Match was made
            ...
            if (mysqli_affected_rows($dbc) == 1) { // If it ran OK
                ...
                <p>Your password has been updated. In Chapter 12 you will 
...
<form action="password.php" method="post">
    <p>Email Address: <input type="email" name="email" size="20" maxlenght="60"
    value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>"></p>
    <p>Current Password: <input type="password" name="pass" size="10" maxlenght="20"
    value="<?php if (isset($_POST['pass'])) echo $_POST['pass']; ?>"></p>
    <p>New Password: <input type="password" name="pass1" size="10" maxlenght="20"
    value="<?php if (isset($_POST['pass1'])) echo $_POST['pass1']; ?>"></p>
    <p>Confirm New Password: <input type="password" name="pass2" size="10" maxlenght="20"
